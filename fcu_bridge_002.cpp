...
static char* DRONE_IP = "192.168.137.101"; //ip
...
int main(int argc, char **argv) {
  ...
  odom=nh.subscribe<nav_msgs::Odometry>("/vins_estimator/odometry_002", 100, odomHandler, ros::TransportHints().tcpNoDelay());
  cmd=nh.subscribe<std_msgs::Int16>("/fcu_bridge/command", 100, cmdHandler, ros::TransportHints().tcpNoDelay());
  mission=nh.subscribe<geometry_msgs::InertiaStamped>("/fcu_bridge/mission_002", 100, missionHandler, ros::TransportHints().tcpNoDelay());
